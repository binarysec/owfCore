...
class core_tpl {
	...
	public function compile($tpl_name) {
		...
		if(!$this->locate($tpl_name)) {
			throw new wf_exception(
				$this,
				WF_EXC_PRIVATE,
				'Template <strong>'.$tpl_name.'</strong> not found.'
			);
			return(false);
		}
		
		/* compile the template */
		$tpl_content = file_get_contents($this->tpl_file);
		...
		file_put_contents($this->cache_file, $res);
